...
describe('Create a new gallery', () => {
    it('create new gallery successfully', () => {
        ...
        creategallery.titleInput.type('Moon')
        creategallery.descriptionInput.type('Vivify')
        creategallery.imageUrlInput.type('https://upload.wikimedia.org/wikipedia/commons/c/c9/Moon.jpg')
        creategallery.SubmitBtn.click()
    });

    it.only('Create new gallery when gallery title contains 2 characters', () => {
        creategallery.createButton.click()
        cy.url().should('eq', 'https://gallery-app.vivifyideas.com/create')
        creategallery.titleInput.type('He')
        creategallery.titleInput.should('have.value', 'He')
        creategallery.descriptionInput.type('Today is a sunny day')
        creategallery.descriptionInput.should('have.value', 'Today is a sunny day')
        creategallery.imageUrlInput.type('https://upload.wikimedia.org/wikipedia/commons/3/3d/Sun_with_sunglasses.jpg')
        creategallery.imageUrlInput.should('be.visible')
        // .and('contain', '.jpg');
        creategallery.SubmitBtn.click()
    });
    ...
    //kako proveriti da li su stvarno dve slike
    it('successfully create new gallery with more than one image', () => {
        creategallery.createButton.click()
        creategallery.titleInput.type('dve slike')
        creategallery.imageUrlInput.type('https://upload.wikimedia.org/wikipedia/commons/3/3d/Sun_with_sunglasses.jpg')
        creategallery.imageUrlInput.should('have.value', 'https://upload.wikimedia.org/wikipedia/commons/3/3d/Sun_with_sunglasses.jpg')
        creategallery.addImageBtn.click()
        creategallery.newImageUrlInput.should('exist')
        creategallery.newImageUrlInput.type('https://upload.wikimedia.org/wikipedia/commons/c/c9/Moon.jpg')
        creategallery.newImageUrlInput.should('have.value', 'https://upload.wikimedia.org/wikipedia/commons/c/c9/Moon.jpg')
        creategallery.SubmitBtn.click()
    });
